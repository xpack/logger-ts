...
[![GitHub package.json version](https://img.shields.io/github/package-json/v/xpack/logger-ts?color=green)](https://github.com/xpack/logger-ts/blob/mater/package.json)
...
- <code>npm dist-tag add @xpack/logger@{customField('releaseVersion')} latest</code>
- `npm dist-tag ls @xpack/logger`
