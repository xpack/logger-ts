...
[![CI on Push](https://github.com/xpack/logger-ts/actions/workflows/test-ci.yml/badge)](https://github.com/xpack/logger-ts/actions/workflows/test-ci.yml)
...
- determine the next version (like <code>6.0.0</code>)
- update the version in the top `package.json` file
- use the new version, suffixed by `-pre`, like <code>6.0.0-pre</code>.
...
- add a new entry like _**\* v6.0.0 prepared**_
- commit with a message like _**prepare v6.0.0**_
...
- commit with _**website: blog post release 6.0.0 published**_
...
```bash
rm -rf ~/tmp/logger-test && mkdir ~/tmp/logger-test && cd ~/tmp/logger-test
npm init --yes
npm install @xpack/logger@next
```
...
[GitHub Actions](https://github.com/xpack/logger-ts/actions/workflows/publish-github-pages.yml).
...
in https://xpack.github.io/logger-ts/blog/
...
Check the result at https://xpack.github.io/logger-ts/.
...
In https://github.com/xpack/logger-ts/milestones:
...
- npmjs.com [`@xpack/logger`](https://www.npmjs.com/package/@xpack/logger/) package
  - latest release, per month
[![npm (scoped)](https://img.shields.io/npm/v/@xpack/logger)](https://www.npmjs.com/package/@xpack/logger/)
[![npm](https://img.shields.io/npm/dm/@xpack/logger)](https://www.npmjs.com/package/@xpack/logger/)
  - all releases [![npm](https://img.shields.io/npm/dt/@xpack/logger)](https://www.npmjs.com/package/@xpack/logger/)
