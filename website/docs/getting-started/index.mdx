...
The xPack Logger is a npm package available as [@xpack/logger](https://www.npmjs.com/package/@xpack/logger)
...
- **Star** the project on [GitHub](https://github.com/xpack/logger-ts/): It helps others discover our work.
